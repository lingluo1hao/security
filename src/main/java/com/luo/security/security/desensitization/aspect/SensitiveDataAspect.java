package com.luo.security.security.desensitization.aspect;
...
import org.kingsun.common.desensitization.annotation.SensitiveDecode;
import org.kingsun.common.desensitization.annotation.SensitiveEncode;
import org.kingsun.common.desensitization.util.SensitiveInfoUtil;
...
public class SensitiveDataAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("@annotation(org.kingsun.common.desensitization.annotation.SensitiveEncode) || @annotation(org.kingsun.common.desensitization.annotation.SensitiveDecode)")
    ...
    public Object around(ProceedingJoinPoint point) throws Throwable {
        ...
        if (encode == null) {
            ...
            if (result instanceof IPage) {
                ...
                if (list.size() > 0) {
                    entity = (Class)list.get(0).getClass();
                }
            }
        ...
        if (resultClass.equals(entity) || entity.equals(Object.class)) {
            ...
            // 方法返回List<实体>
            SensitiveInfoUtil.handlePageList(result, entity, isEncode);
        } else {
            // 方法返回一个对象
